...
const faqData = [
    ...
    },
    {
        ...
        heAnswer:
            "התשובה משתנה בהתאם למספר פרמטרים ובהם  מורכבות העבודה, גודל העבודה, זמינות הלקוח ועוד. לרוב אתר אינטרנט נבנה בטווח של 3 - 7 ימי עסקים",
    },

    {
        ...
        heAnswer:
            "חשוב לי מאוד שהלקוח יסיים את התהליך כאשר הוא מרוצה ולכן אני מסייע גם בהעלאת דף הנחיתה לאוויר ובחירת דומיין",
    },
    {
        key: "five",
